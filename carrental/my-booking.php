...
<li>
                <div class="vehicle_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid);?>""><img src="https://hypercar1.s3.amazonaws.com/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
